...
scene.onOverlapTile(SpriteKind.b, sprites.builtin.field1, function (sprite, location) {
    game.gameOver(true)
})
...
scene.onOverlapTile(SpriteKind.a, assets.tile`miMosaico`, function (sprite, location) {
...
scene.onOverlapTile(SpriteKind.b, assets.tile`miMosaico`, function (sprite, location) {
    scene.setBackgroundImage(img`
        
...
scene.onOverlapTile(SpriteKind.a, sprites.builtin.field1, function (sprite, location) {
    game.gameOver(true)
})
